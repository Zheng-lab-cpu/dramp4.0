...
$query_mysql_one="SELECT DRAMP_ID,Name,Source,Activity,Pubmed_ID FROM general_amps";
...
echo<<<END_END
	<tr><th style="border-right-style: none"><input id="CheckAll" onclick="SelectAll('browse_parent','browse_child')" name="browse_parent" type="checkbox" /></th><th style="border-left-style: none;width:90px;">DRAMP ID</th><th>Peptide NAME</th><th>Source</th><th>Biological Activity</th><th>Pubmed ID</th></tr>
END_END;
